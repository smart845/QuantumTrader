...
(function(){
  ...
  function ensureTemplate(){
    ...
    tpl.innerHTML=`<div class="top-controls"><div class="top-seg" id="spreadsSeg"><button class="active" data-ex="auto">⚙️ Авто</button><button id="spreadsRefresh" title="Обновить">🔄</button></div><span class="mini">Обновлено: <span id="spreadsUpdated">—</span></span></div><div class="mini" style="margin:6px 0 10px;color:#A0ACB9">Источник: CoinGecko (все поддерживаемые CEX и DEX). Пары: USDT / USDC. Порог: ≥ ${MIN_SPREAD}%.</div><table class="top-table" id="spreadsTable"><thead><tr><th>Пара</th><th>Биржа (макс)</th><th>Цена</th><th>Спред %</th><th>Фандинг</th><th>Сделки</th><th>🗑️</th></tr></thead><tbody id="spreadsBody"><tr><td colspan="7">Готов к сканированию...</td></tr></tbody></table><div class="mini" id="spreadsEmpty" style="display:none; padding:8px 0;">Нет активных спредов ≥ ${MIN_SPREAD} % (по всем биржам и DEX)</div>`;
  }
  ...
  document.addEventListener('DOMContentLoaded',()=>{ensureTemplate();observe();});
})();
